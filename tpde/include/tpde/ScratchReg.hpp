...
struct CompilerBase<Adaptor, Derived, Config>::ScratchReg {
    ...
    [[nodiscard]] u8 alloc_gp() noexcept;
    [[nodiscard]] u8 alloc_from_bank(u8 bank) noexcept;

    [[nodiscard]] u8 alloc_from_bank_excluding(u8  bank,
...
template <IRAdaptor Adaptor, typename Derived, CompilerConfig Config>
u8 CompilerBase<Adaptor, Derived, Config>::ScratchReg::alloc_gp() noexcept {
    return alloc_from_bank_excluding(Config::GP_BANK, 0);
}

template <IRAdaptor Adaptor, typename Derived, CompilerConfig Config>
u8 CompilerBase<Adaptor, Derived, Config>::ScratchReg::alloc_from_bank(
    const u8 bank) noexcept {
    return alloc_from_bank_excluding(bank, 0);
}

template <IRAdaptor Adaptor, typename Derived, CompilerConfig Config>
u8 CompilerBase<Adaptor, Derived, Config>::ScratchReg::
