...
void EncodingTargetX64::get_inst_candidates(
  ...
  handle_rm("PXORrr", "PXORrm", 2, "SSE_PXORrr", "SSE_PXORrm");
  handle_rm("PADDBrr", "PADDBrm", 2, "SSE_PADDBrr", "SSE_PADDBrm");
  handle_rm("PADDWrr", "PADDWrm", 2, "SSE_PADDWrr", "SSE_PADDWrm");
  handle_rm("PADDDrr", "PADDDrm", 2, "SSE_PADDDrr", "SSE_PADDDrm");
  handle_rm("PADDQrr", "PADDQrm", 2, "SSE_PADDQrr", "SSE_PADDQrm");
  handle_rm("PSUBBrr", "PSUBBrm", 2, "SSE_PSUBBrr", "SSE_PSUBBrm");
  ...
  handle_rm("PACKSSDWrr", "PACKSSDWrm", 2, "SSE_PACKSSDWrr", "SSE_PACKSSDWrm");
  handle_rm("PUNPCKLBWrr", "PUNPCKLBWrm", 2, "SSE_PUNPCKLBWrr", "SSE_PUNPCKLBWrm");
  handle_rm("PUNPCKLWDrr", "PUNPCKLWDrm", 2, "SSE_PUNPCKLWDrr", "SSE_PUNPCKLWDrm");
  handle_rm("PUNPCKLDQrr", "PUNPCKLDQrm", 2, "SSE_PUNPCKLDQrr", "SSE_PUNPCKLDQrm");
  handle_rm("PUNPCKLQDQrr", "PUNPCKLQDQrm", 2, "SSE_PUNPCKLQDQrr", "SSE_PUNPCKLQDQrm");
  handle_rm("PUNPCKHBWrr", "PUNPCKHBWrm", 2, "SSE_PUNPCKHBWrr", "SSE_PUNPCKHBWrm");
