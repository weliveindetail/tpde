...
; RUN: tpde-llc --target=x86_64 < %s | llvm-readelf -s - | FileCheck %s --enable-var-scope --dump-input always
; RUN: tpde-llc --target=aarch64 < %s | llvm-readelf -s - | FileCheck %s --enable-var-scope --dump-input always
