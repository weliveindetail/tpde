...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    add x0, x0, #0x2, lsl #12 // =0x2000
; ARM64-NEXT:    ldr w0, [x0]
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xc0
; ARM64-NEXT:    ret
...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    add x1, x1, #0x2, lsl #12 // =0x2000
; ARM64-NEXT:    str w0, [x1]
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xc0
; ARM64-NEXT:    ret
