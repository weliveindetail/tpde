...
; ARM64:    nop
; ARM64:    nop
; ARM64:    bl 0x30 <truncf32+0x30>
; ARM64:     R_AARCH64_CALL26 truncf
; ARM64:    ldp x29, x30, [sp]
; ARM64:    add sp, sp, #0xb0
; ARM64:    ret
; ARM64:     ...
entry:
  %1 = call float @llvm.trunc.f32(float %0)
  ret float %1
}

define double @truncf64(double %0) {
; X64-LABEL: truncf64>:
; X64:    push rbp
; X64:    mov rbp, rsp
; X64:    nop word ptr [rax + rax]
...
; ARM64:    nop
; ARM64:    nop
; ARM64:    bl 0xa0 <truncf64+0x30>
; ARM64:     R_AARCH64_CALL26 trunc
; ARM64:    ldp x29, x30, [sp]
; ARM64:    add sp, sp, #0xb0
; ARM64:    ret
; ARM64:     ...
