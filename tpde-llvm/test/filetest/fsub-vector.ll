...
define <2 x float> @fsub_v2f32_1(<2 x float> %0) {
; X64-LABEL: <fsub_v2f32_1>:
; X64:         push rbp
...
define <2 x float> @fsub_v2f32_f32(<2 x float> %0, <2 x float> %1) {
; X64-LABEL: <fsub_v2f32_f32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
...
define <4 x float> @fsub_v4f32_1(<4 x float> %0) {
; X64-LABEL: <fsub_v4f32_1>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
; X64-NEXT:    movaps xmm1, xmmword ptr <fsub_v4f32_1+0x13>
...
define <4 x float> @fsub_v4f32_f32(<4 x float> %0, <4 x float> %1) {
; X64-LABEL: <fsub_v4f32_f32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
...
define <2 x double> @fsub_v2f64_1(<2 x double> %0) {
; X64-LABEL: <fsub_v2f64_1>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
; X64-NEXT:    movaps xmm1, xmmword ptr <fsub_v2f64_1+0x13>
; X64-NEXT:     R_X86_64_PC32 -0x4
; X64-NEXT:    subpd xmm0, xmm1
; X64-NEXT:    add rsp, 0x30
; X64-NEXT:    pop rbp
; X64-NEXT:    ret
;
...
define <2 x double> @fsub_v2f64_f64(<2 x double> %0, <2 x double> %1) {
; X64-LABEL: <fsub_v2f64_f64>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
