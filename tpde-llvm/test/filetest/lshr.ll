...
; ARM64-NEXT:    mov x2, #0x1fffffffff // =137438953471
; ARM64-NEXT:    and x2, x2, x0
; ARM64-NEXT:    mov x3, #0x1fffffffff // =137438953471
; ARM64-NEXT:    and x3, x3, x1
; ARM64-NEXT:    lsr x2, x2, x3
; ARM64-NEXT:    mov x1, #0x1fffffffff // =137438953471
; ARM64-NEXT:    and x1, x1, x0
; ARM64-NEXT:    mov x0, #0x1fffffffff // =137438953471
; ARM64-NEXT:    and x0, x0, x2
; ARM64-NEXT:    lsr x1, x1, x0
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xb0
; ARM64-NEXT:    ret
; ARM64-NEXT:     ...
