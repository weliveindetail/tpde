...
; ARM64-NEXT:    cset w0, eq
; ARM64-NEXT:    strb w0, [x29, #0xae]
; ARM64-NEXT:    mov w0, w3
; ARM64-NEXT:    ldrb w1, [x29, #0xae]
; ARM64-NEXT:    ldp x29, x30, [sp]
...
; ARM64-NEXT:    cset w0, eq
; ARM64-NEXT:    strb w0, [x29, #0xab]
; ARM64-NEXT:    mov w0, w3
; ARM64-NEXT:    ldrb w1, [x29, #0xab]
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xb0
; ARM64-NEXT:    ret
