...
template <typename T> bool sub_of(T a, T b) {
    T res;
    return __builtin_sub_overflow(a, b, &res);
}

void usub_128(__uint128_t a, __uint128_t b) {
    __uint128_t res;
    bool of = __builtin_sub_overflow(a, b, &res);
    printf("%lx, %lx, %d\n", (uint64_t)(res >> 64), (uint64_t)(res), of);
}

void ssub_128(__int128_t a, __int128_t b) {
    __int128_t res;
    bool of = __builtin_sub_overflow(a, b, &res);
    printf("%lx, %lx, %d\n", (uint64_t)(res >> 64), (uint64_t)(res), of);
}
...
int main() {
    // OUT: 1, 0
    printf("%d, %d\n", sub<int8_t>(3, 2), sub_of<int8_t>(3, 2));
    // OUT: 127, 1
    printf("%d, %d\n", sub<int8_t>(-128, 1), sub_of<int8_t>(-128, 1));
    // OUT: -128, 1
    printf("%d, %d\n", sub<int8_t>(127, -1), sub_of<int8_t>(127, -1));

    // OUT: 1, 0
    printf("%x, %d\n", sub<uint8_t>(3, 2), sub_of<uint8_t>(3, 2));
    // OUT: ff, 1
    printf("%x, %d\n", sub<uint8_t>(0, 1), sub_of<uint8_t>(0, 1));
    // OUT: 7f, 0
    printf("%x, %d\n", sub<uint8_t>(0x80, 1), sub_of<uint8_t>(0x80, 1));


    // OUT: 1, 0
    printf("%d, %d\n", sub<int16_t>(3, 2), sub_of<int16_t>(3, 2));
    // OUT: 32767, 1
    printf("%d, %d\n", sub<int16_t>(0x8000, 1), sub_of<int16_t>(0x8000, 1));
    // OUT: -32768, 1
    printf("%d, %d\n", sub<int16_t>(0x7FFF, -1), sub_of<int16_t>(0x7FFF, -1));

    // OUT: 1, 0
    printf("%x, %d\n", sub<uint16_t>(3, 2), sub_of<uint16_t>(3, 2));
    // OUT: ffff, 1
    printf("%x, %d\n", sub<uint16_t>(0, 1), sub_of<uint16_t>(0, 1));
    // OUT: 7fff, 0
    printf("%x, %d\n", sub<uint16_t>(0x8000, 1), sub_of<uint16_t>(0x8000, 1));


    // OUT: 1, 0
    printf("%d, %d\n", sub<int32_t>(3, 2), sub_of<int32_t>(3, 2));
    // OUT: 2147483647, 1
    printf("%d, %d\n", sub<int32_t>(0x8000'0000, 1), sub_of<int32_t>(0x8000'0000, 1));
    // OUT: -2147483648, 1
    printf("%d, %d\n", sub<int32_t>(0x7FFF'FFFF, -1), sub_of<int32_t>(0x7FFF'FFFF, -1));

    // OUT: 1, 0
    printf("%x, %d\n", sub<uint32_t>(3, 2), sub_of<uint32_t>(3, 2));
    // OUT: ffffffff, 1
    printf("%x, %d\n", sub<uint32_t>(0, 1), sub_of<uint32_t>(0, 1));
    // OUT: 7fffffff, 0
    printf("%x, %d\n", sub<uint32_t>(0x8000'0000, 1), sub_of<uint32_t>(0x8000'0000, 1));


    // OUT: 1, 0
    printf("%ld, %d\n", sub<int64_t>(3, 2), sub_of<int64_t>(3, 2));
    // OUT: 9223372036854775807, 1
    printf("%ld, %d\n", sub<int64_t>(0x8000'0000'0000'0000, 1), sub_of<int64_t>(0x8000'0000'0000'0000, 1));
    // OUT: -9223372036854775808, 1
    printf("%ld, %d\n", sub<int64_t>(0x7FFF'FFFF'FFFF'FFFF, -1), sub_of<int64_t>(0x7FFF'FFFF'FFFF'FFFF, -1));

    // OUT: 1, 0
    printf("%lx, %d\n", sub<uint64_t>(3, 2), sub_of<uint64_t>(3, 2));
    // OUT: ffffffffffffffff, 1
    printf("%lx, %d\n", sub<uint64_t>(0, 1), sub_of<uint64_t>(0, 1));
    // OUT: 7fffffffffffffff, 0
    printf("%lx, %d\n", sub<uint64_t>(0x8000'0000'0000'0000, 1), sub_of<uint64_t>(0x8000'0000'0000'0000, 1));


    // OUT: 0, 1, 0
    ssub_128(3, 2);
    // OUT: 7fffffffffffffff, ffffffffffffffff, 1
    ssub_128(((__int128_t)0x8000'0000'0000'0000) << 64, 1);
    // OUT: 8000000000000000, 0, 1
    ssub_128(((__int128_t)0x7FFF'FFFF'FFFF'FFFF) << 64 | 0xFFFF'FFFF'FFFF'FFFF, -1);

    // OUT: 0, 1, 0
    usub_128(3, 2);
    // OUT: ffffffffffffffff, ffffffffffffffff, 1
    usub_128(0, 1);
    // OUT: 7fffffffffffffff, ffffffffffffffff, 0
    usub_128(((__uint128_t)0x8000'0000'0000'0000) << 64, 1);

    return 0;
}
// IR-LABEL: define dso_local void @_Z8usub_128oo(
...
// IR-NEXT:    [[TMP6:%.*]] = call { i128, i1 } @llvm.usub.with.overflow.i128(i128 [[TMP4]], i128 [[TMP5]])
...
//
//
// IR-LABEL: define dso_local void @_Z8ssub_128nn(
...
// IR-NEXT:    [[TMP4:%.*]] = load i128, ptr [[A_ADDR]], align 16
// IR-NEXT:    [[TMP5:%.*]] = load i128, ptr [[B_ADDR]], align 16
// IR-NEXT:    [[TMP6:%.*]] = call { i128, i1 } @llvm.ssub.with.overflow.i128(i128 [[TMP4]], i128 [[TMP5]])
// IR-NEXT:    [[TMP7:%.*]] = extractvalue { i128, i1 } [[TMP6]], 1
// IR-NEXT:    [[TMP8:%.*]] = extractvalue { i128, i1 } [[TMP6]], 0
// IR-NEXT:    store i128 [[TMP8]], ptr [[RES]], align 16
// IR-NEXT:    [[FROMBOOL:%.*]] = zext i1 [[TMP7]] to i8
...
// IR-NEXT:    [[CALL:%.*]] = call noundef signext i8 @_Z3subIaET_S0_S0_(i8 noundef signext 3, i8 noundef signext 2)
// IR-NEXT:    [[CONV:%.*]] = sext i8 [[CALL]] to i32
// IR-NEXT:    [[CALL1:%.*]] = call noundef zeroext i1 @_Z6sub_ofIaEbT_S0_(i8 noundef signext 3, i8 noundef signext 2)
// IR-NEXT:    [[CONV2:%.*]] = zext i1 [[CALL1]] to i32
// IR-NEXT:    [[CALL3:%.*]] = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef [[CONV]], i32 noundef [[CONV2]])
// IR-NEXT:    [[CALL4:%.*]] = call noundef signext i8 @_Z3subIaET_S0_S0_(i8 noundef signext -128, i8 noundef signext 1)
// IR-NEXT:    [[CONV5:%.*]] = sext i8 [[CALL4]] to i32
// IR-NEXT:    [[CALL6:%.*]] = call noundef zeroext i1 @_Z6sub_ofIaEbT_S0_(i8 noundef signext -128, i8 noundef signext 1)
...
// IR-NEXT:    [[CALL9:%.*]] = call noundef signext i8 @_Z3subIaET_S0_S0_(i8 noundef signext 127, i8 noundef signext -1)
// IR-NEXT:    [[CONV10:%.*]] = sext i8 [[CALL9]] to i32
// IR-NEXT:    [[CALL11:%.*]] = call noundef zeroext i1 @_Z6sub_ofIaEbT_S0_(i8 noundef signext 127, i8 noundef signext -1)
...
// IR-NEXT:    [[CALL14:%.*]] = call noundef zeroext i8 @_Z3subIhET_S0_S0_(i8 noundef zeroext 3, i8 noundef zeroext 2)
// IR-NEXT:    [[CONV15:%.*]] = zext i8 [[CALL14]] to i32
// IR-NEXT:    [[CALL16:%.*]] = call noundef zeroext i1 @_Z6sub_ofIhEbT_S0_(i8 noundef zeroext 3, i8 noundef zeroext 2)
...
// IR-NEXT:    [[CALL19:%.*]] = call noundef zeroext i8 @_Z3subIhET_S0_S0_(i8 noundef zeroext 0, i8 noundef zeroext 1)
// IR-NEXT:    [[CONV20:%.*]] = zext i8 [[CALL19]] to i32
// IR-NEXT:    [[CALL21:%.*]] = call noundef zeroext i1 @_Z6sub_ofIhEbT_S0_(i8 noundef zeroext 0, i8 noundef zeroext 1)
...
// IR-NEXT:    [[CALL24:%.*]] = call noundef zeroext i8 @_Z3subIhET_S0_S0_(i8 noundef zeroext -128, i8 noundef zeroext 1)
// IR-NEXT:    [[CONV25:%.*]] = zext i8 [[CALL24]] to i32
// IR-NEXT:    [[CALL26:%.*]] = call noundef zeroext i1 @_Z6sub_ofIhEbT_S0_(i8 noundef zeroext -128, i8 noundef zeroext 1)
...
// IR-NEXT:    [[CALL29:%.*]] = call noundef signext i16 @_Z3subIsET_S0_S0_(i16 noundef signext 3, i16 noundef signext 2)
// IR-NEXT:    [[CONV30:%.*]] = sext i16 [[CALL29]] to i32
// IR-NEXT:    [[CALL31:%.*]] = call noundef zeroext i1 @_Z6sub_ofIsEbT_S0_(i16 noundef signext 3, i16 noundef signext 2)
...
// IR-NEXT:    [[CALL34:%.*]] = call noundef signext i16 @_Z3subIsET_S0_S0_(i16 noundef signext -32768, i16 noundef signext 1)
// IR-NEXT:    [[CONV35:%.*]] = sext i16 [[CALL34]] to i32
// IR-NEXT:    [[CALL36:%.*]] = call noundef zeroext i1 @_Z6sub_ofIsEbT_S0_(i16 noundef signext -32768, i16 noundef signext 1)
...
// IR-NEXT:    [[CALL39:%.*]] = call noundef signext i16 @_Z3subIsET_S0_S0_(i16 noundef signext 32767, i16 noundef signext -1)
// IR-NEXT:    [[CONV40:%.*]] = sext i16 [[CALL39]] to i32
// IR-NEXT:    [[CALL41:%.*]] = call noundef zeroext i1 @_Z6sub_ofIsEbT_S0_(i16 noundef signext 32767, i16 noundef signext -1)
...
// IR-NEXT:    [[CALL44:%.*]] = call noundef zeroext i16 @_Z3subItET_S0_S0_(i16 noundef zeroext 3, i16 noundef zeroext 2)
// IR-NEXT:    [[CONV45:%.*]] = zext i16 [[CALL44]] to i32
// IR-NEXT:    [[CALL46:%.*]] = call noundef zeroext i1 @_Z6sub_ofItEbT_S0_(i16 noundef zeroext 3, i16 noundef zeroext 2)
...
// IR-NEXT:    [[CALL49:%.*]] = call noundef zeroext i16 @_Z3subItET_S0_S0_(i16 noundef zeroext 0, i16 noundef zeroext 1)
// IR-NEXT:    [[CONV50:%.*]] = zext i16 [[CALL49]] to i32
// IR-NEXT:    [[CALL51:%.*]] = call noundef zeroext i1 @_Z6sub_ofItEbT_S0_(i16 noundef zeroext 0, i16 noundef zeroext 1)
...
// IR-NEXT:    [[CALL54:%.*]] = call noundef zeroext i16 @_Z3subItET_S0_S0_(i16 noundef zeroext -32768, i16 noundef zeroext 1)
// IR-NEXT:    [[CONV55:%.*]] = zext i16 [[CALL54]] to i32
// IR-NEXT:    [[CALL56:%.*]] = call noundef zeroext i1 @_Z6sub_ofItEbT_S0_(i16 noundef zeroext -32768, i16 noundef zeroext 1)
...
// IR-NEXT:    [[CALL59:%.*]] = call noundef i32 @_Z3subIiET_S0_S0_(i32 noundef 3, i32 noundef 2)
// IR-NEXT:    [[CALL60:%.*]] = call noundef zeroext i1 @_Z6sub_ofIiEbT_S0_(i32 noundef 3, i32 noundef 2)
...
// IR-NEXT:    [[CALL63:%.*]] = call noundef i32 @_Z3subIiET_S0_S0_(i32 noundef -2147483648, i32 noundef 1)
// IR-NEXT:    [[CALL64:%.*]] = call noundef zeroext i1 @_Z6sub_ofIiEbT_S0_(i32 noundef -2147483648, i32 noundef 1)
...
// IR-NEXT:    [[CALL67:%.*]] = call noundef i32 @_Z3subIiET_S0_S0_(i32 noundef 2147483647, i32 noundef -1)
// IR-NEXT:    [[CALL68:%.*]] = call noundef zeroext i1 @_Z6sub_ofIiEbT_S0_(i32 noundef 2147483647, i32 noundef -1)
...
// IR-NEXT:    [[CALL71:%.*]] = call noundef i32 @_Z3subIjET_S0_S0_(i32 noundef 3, i32 noundef 2)
// IR-NEXT:    [[CALL72:%.*]] = call noundef zeroext i1 @_Z6sub_ofIjEbT_S0_(i32 noundef 3, i32 noundef 2)
...
// IR-NEXT:    [[CALL75:%.*]] = call noundef i32 @_Z3subIjET_S0_S0_(i32 noundef 0, i32 noundef 1)
// IR-NEXT:    [[CALL76:%.*]] = call noundef zeroext i1 @_Z6sub_ofIjEbT_S0_(i32 noundef 0, i32 noundef 1)
...
// IR-NEXT:    [[CALL79:%.*]] = call noundef i32 @_Z3subIjET_S0_S0_(i32 noundef -2147483648, i32 noundef 1)
// IR-NEXT:    [[CALL80:%.*]] = call noundef zeroext i1 @_Z6sub_ofIjEbT_S0_(i32 noundef -2147483648, i32 noundef 1)
...
// IR-NEXT:    [[CALL83:%.*]] = call noundef i64 @_Z3subIlET_S0_S0_(i64 noundef 3, i64 noundef 2)
// IR-NEXT:    [[CALL84:%.*]] = call noundef zeroext i1 @_Z6sub_ofIlEbT_S0_(i64 noundef 3, i64 noundef 2)
...
// IR-NEXT:    [[CALL87:%.*]] = call noundef i64 @_Z3subIlET_S0_S0_(i64 noundef -9223372036854775808, i64 noundef 1)
// IR-NEXT:    [[CALL88:%.*]] = call noundef zeroext i1 @_Z6sub_ofIlEbT_S0_(i64 noundef -9223372036854775808, i64 noundef 1)
...
// IR-NEXT:    [[CALL91:%.*]] = call noundef i64 @_Z3subIlET_S0_S0_(i64 noundef 9223372036854775807, i64 noundef -1)
// IR-NEXT:    [[CALL92:%.*]] = call noundef zeroext i1 @_Z6sub_ofIlEbT_S0_(i64 noundef 9223372036854775807, i64 noundef -1)
...
// IR-NEXT:    [[CALL95:%.*]] = call noundef i64 @_Z3subImET_S0_S0_(i64 noundef 3, i64 noundef 2)
// IR-NEXT:    [[CALL96:%.*]] = call noundef zeroext i1 @_Z6sub_ofImEbT_S0_(i64 noundef 3, i64 noundef 2)
...
// IR-NEXT:    [[CALL99:%.*]] = call noundef i64 @_Z3subImET_S0_S0_(i64 noundef 0, i64 noundef 1)
// IR-NEXT:    [[CALL100:%.*]] = call noundef zeroext i1 @_Z6sub_ofImEbT_S0_(i64 noundef 0, i64 noundef 1)
...
// IR-NEXT:    [[CALL103:%.*]] = call noundef i64 @_Z3subImET_S0_S0_(i64 noundef -9223372036854775808, i64 noundef 1)
// IR-NEXT:    [[CALL104:%.*]] = call noundef zeroext i1 @_Z6sub_ofImEbT_S0_(i64 noundef -9223372036854775808, i64 noundef 1)
...
// IR-NEXT:    call void @_Z8ssub_128nn(i64 noundef [[TMP1]], i64 noundef [[TMP3]], i64 noundef [[TMP5]], i64 noundef [[TMP7]])
...
// IR-NEXT:    call void @_Z8ssub_128nn(i64 noundef [[TMP9]], i64 noundef [[TMP11]], i64 noundef [[TMP13]], i64 noundef [[TMP15]])
...
// IR-NEXT:    call void @_Z8ssub_128nn(i64 noundef [[TMP17]], i64 noundef [[TMP19]], i64 noundef [[TMP21]], i64 noundef [[TMP23]])
...
// IR-NEXT:    call void @_Z8usub_128oo(i64 noundef [[TMP25]], i64 noundef [[TMP27]], i64 noundef [[TMP29]], i64 noundef [[TMP31]])
// IR-NEXT:    store i128 0, ptr [[COERCE114]], align 16
...
// IR-NEXT:    call void @_Z8usub_128oo(i64 noundef [[TMP33]], i64 noundef [[TMP35]], i64 noundef [[TMP37]], i64 noundef [[TMP39]])
...
// IR-NEXT:    call void @_Z8usub_128oo(i64 noundef [[TMP41]], i64 noundef [[TMP43]], i64 noundef [[TMP45]], i64 noundef [[TMP47]])
// IR-NEXT:    ret i32 0
//
//
// IR-LABEL: define linkonce_odr dso_local noundef signext i8 @_Z3subIaET_S0_S0_(
...
// IR-NEXT:    [[TMP2:%.*]] = call { i8, i1 } @llvm.ssub.with.overflow.i8(i8 [[TMP0]], i8 [[TMP1]])
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIaEbT_S0_(
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i8 @_Z3subIhET_S0_S0_(
...
// IR-NEXT:    [[TMP0:%.*]] = load i8, ptr [[A_ADDR]], align 1
// IR-NEXT:    [[TMP1:%.*]] = load i8, ptr [[B_ADDR]], align 1
// IR-NEXT:    [[TMP2:%.*]] = call { i8, i1 } @llvm.usub.with.overflow.i8(i8 [[TMP0]], i8 [[TMP1]])
// IR-NEXT:    [[TMP3:%.*]] = extractvalue { i8, i1 } [[TMP2]], 1
// IR-NEXT:    [[TMP4:%.*]] = extractvalue { i8, i1 } [[TMP2]], 0
// IR-NEXT:    store i8 [[TMP4]], ptr [[RES]], align 1
// IR-NEXT:    [[TMP5:%.*]] = load i8, ptr [[RES]], align 1
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIhEbT_S0_(
// IR-SAME: i8 noundef zeroext [[A:%.*]], i8 noundef zeroext [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i8, align 1
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i8, align 1
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef signext i16 @_Z3subIsET_S0_S0_(
...
// IR-NEXT:    [[TMP2:%.*]] = call { i16, i1 } @llvm.ssub.with.overflow.i16(i16 [[TMP0]], i16 [[TMP1]])
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIsEbT_S0_(
// IR-SAME: i16 noundef signext [[A:%.*]], i16 noundef signext [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i16, align 2
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i16, align 2
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i16 @_Z3subItET_S0_S0_(
...
// IR-NEXT:    [[TMP0:%.*]] = load i16, ptr [[A_ADDR]], align 2
// IR-NEXT:    [[TMP1:%.*]] = load i16, ptr [[B_ADDR]], align 2
// IR-NEXT:    [[TMP2:%.*]] = call { i16, i1 } @llvm.usub.with.overflow.i16(i16 [[TMP0]], i16 [[TMP1]])
// IR-NEXT:    [[TMP3:%.*]] = extractvalue { i16, i1 } [[TMP2]], 1
// IR-NEXT:    [[TMP4:%.*]] = extractvalue { i16, i1 } [[TMP2]], 0
// IR-NEXT:    store i16 [[TMP4]], ptr [[RES]], align 2
// IR-NEXT:    [[TMP5:%.*]] = load i16, ptr [[RES]], align 2
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofItEbT_S0_(
// IR-SAME: i16 noundef zeroext [[A:%.*]], i16 noundef zeroext [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i16, align 2
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i16, align 2
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef i32 @_Z3subIiET_S0_S0_(
...
// IR-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]])
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIiEbT_S0_(
// IR-SAME: i32 noundef [[A:%.*]], i32 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i32, align 4
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i32, align 4
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef i32 @_Z3subIjET_S0_S0_(
// IR-SAME: i32 noundef [[A:%.*]], i32 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i32, align 4
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i32, align 4
...
// IR-NEXT:    [[TMP0:%.*]] = load i32, ptr [[A_ADDR]], align 4
// IR-NEXT:    [[TMP1:%.*]] = load i32, ptr [[B_ADDR]], align 4
// IR-NEXT:    [[TMP2:%.*]] = call { i32, i1 } @llvm.usub.with.overflow.i32(i32 [[TMP0]], i32 [[TMP1]])
// IR-NEXT:    [[TMP3:%.*]] = extractvalue { i32, i1 } [[TMP2]], 1
// IR-NEXT:    [[TMP4:%.*]] = extractvalue { i32, i1 } [[TMP2]], 0
// IR-NEXT:    store i32 [[TMP4]], ptr [[RES]], align 4
// IR-NEXT:    [[TMP5:%.*]] = load i32, ptr [[RES]], align 4
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIjEbT_S0_(
// IR-SAME: i32 noundef [[A:%.*]], i32 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i32, align 4
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i32, align 4
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef i64 @_Z3subIlET_S0_S0_(
...
// IR-NEXT:    [[TMP2:%.*]] = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 [[TMP0]], i64 [[TMP1]])
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofIlEbT_S0_(
// IR-SAME: i64 noundef [[A:%.*]], i64 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i64, align 8
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i64, align 8
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef i64 @_Z3subImET_S0_S0_(
// IR-SAME: i64 noundef [[A:%.*]], i64 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i64, align 8
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i64, align 8
...
// IR-NEXT:    [[TMP0:%.*]] = load i64, ptr [[A_ADDR]], align 8
// IR-NEXT:    [[TMP1:%.*]] = load i64, ptr [[B_ADDR]], align 8
// IR-NEXT:    [[TMP2:%.*]] = call { i64, i1 } @llvm.usub.with.overflow.i64(i64 [[TMP0]], i64 [[TMP1]])
// IR-NEXT:    [[TMP3:%.*]] = extractvalue { i64, i1 } [[TMP2]], 1
// IR-NEXT:    [[TMP4:%.*]] = extractvalue { i64, i1 } [[TMP2]], 0
// IR-NEXT:    store i64 [[TMP4]], ptr [[RES]], align 8
// IR-NEXT:    [[TMP5:%.*]] = load i64, ptr [[RES]], align 8
...
//
//
// IR-LABEL: define linkonce_odr dso_local noundef zeroext i1 @_Z6sub_ofImEbT_S0_(
// IR-SAME: i64 noundef [[A:%.*]], i64 noundef [[B:%.*]]) #[[ATTR4]] comdat {
// IR-NEXT:  [[ENTRY:.*:]]
// IR-NEXT:    [[A_ADDR:%.*]] = alloca i64, align 8
// IR-NEXT:    [[B_ADDR:%.*]] = alloca i64, align 8
