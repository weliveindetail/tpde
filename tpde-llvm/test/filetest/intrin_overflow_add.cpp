...
template <typename T> bool add_of(T a, T b) {
    T res;
...
int main() {
    ...
    // OUT: 2147483647, 1
    printf("%d, %d\n", add<int32_t>(0x8000'0000, -1), add_of<int32_t>(0x8000'0000, -1));
    // OUT: -2147483648, 1
    printf("%d, %d\n", add<int32_t>(0x7FFF'FFFF, 1), add_of<int32_t>(0x7FFF'FFFF, 1));

    // OUT: 3, 0
    printf("%x, %d\n", add<uint32_t>(1, 2), add_of<uint32_t>(1, 2));
    // OUT: 0, 1
    printf("%x, %d\n", add<uint32_t>(0xFFFF'FFFF, 1), add_of<uint32_t>(0xFFFF'FFFF, 1));
    // OUT: 80000000, 0
    printf("%x, %d\n", add<uint32_t>(0x7FFF'FFFF, 1), add_of<uint32_t>(0x7FFF'FFFF, 1));


    // OUT: 3, 0
    printf("%ld, %d\n", add<int64_t>(1, 2), add_of<int64_t>(1, 2));
    // OUT: 9223372036854775807, 1
    printf("%ld, %d\n", add<int64_t>(0x8000'0000'0000'0000, -1), add_of<int64_t>(0x8000'0000'0000'0000, -1));
    // OUT: -9223372036854775808, 1
    printf("%ld, %d\n", add<int64_t>(0x7FFF'FFFF'FFFF'FFFF, 1), add_of<int64_t>(0x7FFF'FFFF'FFFF'FFFF, 1));

    // OUT: 3, 0
    printf("%lx, %d\n", add<uint64_t>(1, 2), add_of<uint64_t>(1, 2));
    // OUT: 0, 1
    printf("%lx, %d\n", add<uint64_t>(0xFFFF'FFFF'FFFF'FFFF, 1), add_of<uint64_t>(0xFFFF'FFFF'FFFF'FFFF, 1));
    // OUT: 8000000000000000, 0
    printf("%lx, %d\n", add<uint64_t>(0x7FFF'FFFF'FFFF'FFFF, 1), add_of<uint64_t>(0x7FFF'FFFF'FFFF'FFFF, 1));
    ...
    sadd_128(((__int128_t)0x7FFF'FFFF'FFFF'FFFF) << 64 | 0xFFFF'FFFF'FFFF'FFFF, 1);
    ...
    uadd_128(((__uint128_t)0x7FFF'FFFF'FFFF'FFFF) << 64 | 0xFFFF'FFFF'FFFF'FFFF, 1);
