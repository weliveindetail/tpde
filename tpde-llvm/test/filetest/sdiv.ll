...
; ARM64-NEXT:    mov x29, sp
; ARM64-NEXT:    nop
; ARM64-NEXT:    bl 0xc90 <sdiv_i128+0x10>
...
define i128 @sdiv_i128_twice(i128 %0, i128 %1) {
; X64-LABEL: <sdiv_i128_twice>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x60
...
; ARM64-NEXT:    bl 0xd08 <sdiv_i128_twice+0x18>
; ARM64-NEXT:     R_AARCH64_CALL26 __divti3
; ARM64-NEXT:    str x0, [x29, #0xc0]
; ARM64-NEXT:    ldr x0, [x29, #0xa0]
; ARM64-NEXT:    str x1, [x29, #0xc8]
; ARM64-NEXT:    ldr x1, [x29, #0xa8]
; ARM64-NEXT:    ldr x2, [x29, #0xc0]
; ARM64-NEXT:    ldr x3, [x29, #0xc8]
; ARM64-NEXT:    bl 0xd24 <sdiv_i128_twice+0x34>
; ARM64-NEXT:     R_AARCH64_CALL26 __divti3
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xd0
; ARM64-NEXT:    ret
