...
define float @fadd_f32_5_32(float %0) {
; X64-LABEL: <fadd_f32_5_32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x30
...
define float @fadd_f32_f32(float %0, float %1) {
; X64-LABEL: <fadd_f32_f32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
...
define double @fadd_f64_1(double %0) {
; X64-LABEL: <fadd_f64_1>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define double @fadd_f64_5_32(double %0) {
; X64-LABEL: <fadd_f64_5_32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define double @fadd_f64_f64(double %0, double %1) {
; X64-LABEL: <fadd_f64_f64>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define float @fadd_f32_no_salvage_imm(float %0) {
; X64-LABEL: <fadd_f32_no_salvage_imm>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define float @fadd_f32_no_salvage_reg(float %0, float %1) {
; X64-LABEL: <fadd_f32_no_salvage_reg>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define double @fadd_f64_no_salvage_imm(double %0) {
; X64-LABEL: <fadd_f64_no_salvage_imm>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
...
define double @fadd_f64_no_salvage_reg(double %0, double %1) {
; X64-LABEL: <fadd_f64_no_salvage_reg>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
; X64-NEXT:    sub rsp, 0x40
; X64-NEXT:    movapd xmm2, xmm0
; X64-NEXT:    addsd xmm2, xmm1
...
define fp128 @fadd_f128(fp128 %a, fp128 %b) {
; X64-LABEL: <fadd_f128>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    nop word ptr [rax + rax]
