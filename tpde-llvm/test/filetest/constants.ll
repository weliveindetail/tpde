...
; ARM64-NEXT:    mov w1, #0x0 // =0
; ARM64-NEXT:    tst w1, #0x1
; ARM64-NEXT:    b.eq 0x6c4 <phi_ptrtoint_trunc_add+0x44>
; ARM64-NEXT:    mov w20, w0
; ARM64-NEXT:    b 0x6a4 <phi_ptrtoint_trunc_add+0x24>
...
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    tst w0, #0x1
; ARM64-NEXT:    b.eq 0x744 <phi_struct1+0x44>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str w0, [x29, #0xa0]
; ARM64-NEXT:    mov x0, #0x1 // =1
; ARM64-NEXT:    str w0, [x29, #0xa4]
; ARM64-NEXT:    b 0x724 <phi_struct1+0x24>
...
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    tst w0, #0x1
; ARM64-NEXT:    b.eq 0x7dc <phi_struct2+0x4c>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str w0, [x29, #0xa0]
; ARM64-NEXT:    adrp x0, 0x0 <.text>
; ARM64-NEXT:     R_AARCH64_ADR_PREL_PG_HI21 glob
...
; ARM64-NEXT:     R_AARCH64_ADD_ABS_LO12_NC glob
; ARM64-NEXT:    str x0, [x29, #0xa8]
; ARM64-NEXT:    b 0x7b8 <phi_struct2+0x28>
; ARM64-NEXT:    ldr w0, [x29, #0xa0]
; ARM64-NEXT:    str w0, [x19]
...
; ARM64-NEXT:    b.eq 0x87c <phi_struct3+0x5c>
; ARM64-NEXT:    str w1, [x29, #0xa0]
; ARM64-NEXT:    str w0, [x29, #0xa4]
; ARM64-NEXT:    b 0x850 <phi_struct3+0x30>
; ARM64-NEXT:    ldr w0, [x29, #0xa0]
; ARM64-NEXT:    str w0, [x19]
; ARM64-NEXT:    ldr w0, [x29, #0xa4]
; ARM64-NEXT:    str w0, [x19, #0x4]
...
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    tst w0, #0x1
; ARM64-NEXT:    b.ne 0x8ec <phi_gep_before_icmp+0x3c>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    mov w20, w0
; ARM64-NEXT:    b 0x928 <phi_gep_before_icmp+0x78>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    mov x16, #0x1200 // =4608
; ARM64-NEXT:    add x0, x0, x16
; ARM64-NEXT:    mov w1, #0x0 // =0
; ARM64-NEXT:    cbnz w1, 0x908 <phi_gep_before_icmp+0x58>
; ARM64-NEXT:    mov w20, w19
; ARM64-NEXT:    b 0x928 <phi_gep_before_icmp+0x78>
; ARM64-NEXT:    mov x21, x0
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    tst w0, #0x1
; ARM64-NEXT:    b.ne 0x924 <phi_gep_before_icmp+0x74>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    mov x21, x0
; ARM64-NEXT:    b 0x90c <phi_gep_before_icmp+0x5c>
; ARM64-NEXT:    mov w20, w19
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    ldp x19, x20, [sp, #0x10]
...
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    mov x20, x0
; ARM64-NEXT:    b 0x9a4 <phi_gep_before_icmp_twice+0x44>
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    mov x19, x0
; ARM64-NEXT:    b 0x9c4 <phi_gep_before_icmp_twice+0x64>
  br label %1
