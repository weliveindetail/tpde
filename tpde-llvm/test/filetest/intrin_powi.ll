...
; X64:  <L0>:
; X64:    call <L0>
; X64:     R_X86_64_PLT32 __powisf2-0x4
; X64:    add rsp, 0x30
; X64:    pop rbp
; X64:    ret
; X64:    nop word ptr [rax + rax]
...
; ARM64:    nop
; ARM64:    mov x0, #0xa // =10
; ARM64:    bl 0x34 <powif32+0x34>
; ARM64:     R_AARCH64_CALL26 __powisf2
...
; X64:  <L0>:
; X64:    call <L0>
; X64:     R_X86_64_PLT32 __powidf2-0x4
; X64:    add rsp, 0x40
; X64:    pop rbp
; X64:    ret
; X64:    nop word ptr [rax + rax]
...
; ARM64:    nop
; ARM64:    nop
; ARM64:    bl 0xa0 <powif64+0x30>
; ARM64:     R_AARCH64_CALL26 __powidf2
; ARM64:    ldp x29, x30, [sp]
