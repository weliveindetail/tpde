...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    bl 0x30 <call_void_void+0x30>
...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    bl 0xa0 <call_i32_void+0x30>
...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    bl 0x110 <call_i128_void+0x30>
...
; ARM64-NEXT:    bl 0x194 <call_i128_void_ret_i32+0x34>
; ARM64-NEXT:     R_AARCH64_CALL26 fn_i128_void
; ARM64-NEXT:    adds x2, x0, #0xa
; ARM64-NEXT:    mov w3, #0x0 // =0
; ARM64-NEXT:    adc x3, x3, x1
...
; ARM64-NEXT:    bl 0x218 <call_void_i32+0x38>
...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    bl 0x280 <call_void_i32_mismatch+0x30>
; ARM64-NEXT:     R_AARCH64_CALL26 fn_void_i32
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xb0
; ARM64-NEXT:    ret
...
; ARM64-NEXT:    bl 0x2fc <call_i32_i32_i32+0x3c>
...
; ARM64-NEXT:    bl 0x378 <call_i32_i32_i128_i128_i128+0x48>
...
; ARM64-NEXT:    bl 0x3e4 <call_i32_vararg+0x34>
...
; ARM64-NEXT:    add x9, x9, #0x8
; ARM64-NEXT:    ldr w9, [x9]
; ARM64-NEXT:    add w0, w0, w9
; ARM64-NEXT:    ldp x29, x30, [sp]
; ARM64-NEXT:    add sp, sp, #0xc0
; ARM64-NEXT:    ret
; ARM64-NEXT:     ...
...
; ARM64-NEXT:    bl 0x558 <call_byval+0x48>
...
; X64-NEXT:    mov qword ptr [rax], 0x1
; X64-NEXT:    lea rax, [rdi + 0x8]
; X64-NEXT:    mov qword ptr [rax], 0x2
; X64-NEXT:    lea rdi, [rdi + 0x10]
; X64-NEXT:    mov qword ptr [rdi], 0x3
; X64-NEXT:    add rsp, 0x40
; X64-NEXT:    pop rbp
; X64-NEXT:    ret
; X64-NEXT:    nop word ptr [rax + rax]
...
; ARM64-NEXT:    nop
; ARM64-NEXT:    nop
; ARM64-NEXT:    mov x0, x8
; ARM64-NEXT:    mov x1, #0x1 // =1
; ARM64-NEXT:    str x1, [x0]
; ARM64-NEXT:    add x0, x8, #0x8
; ARM64-NEXT:    mov x1, #0x2 // =2
; ARM64-NEXT:    str x1, [x0]
; ARM64-NEXT:    add x8, x8, #0x10
...
; ARM64-NEXT:    bl 0x654 <call_sret+0x34>
